...
modelpath <- file.path("C:/Users/conno/Documents/Corsica deer/corsica_deer_ABM/Modelling/NetLogo/Model 4 - death/deer_dispersal_death_v6.3.nlogo")
outpath <- file.path("C:/Users/conno/Documents/Corsica deer/corsica_deer_ABM/Modelling/NetLogo/Model 4 - death/Results")
...
nl@experiment <- experiment(expname = "corsica-deer",
                            ...
                            constants = list("se-agricultural:step-length:winter:female" = 0.04976,
                                             ...
                                             "se-artificial:step-length:summerr:female" = 0,
