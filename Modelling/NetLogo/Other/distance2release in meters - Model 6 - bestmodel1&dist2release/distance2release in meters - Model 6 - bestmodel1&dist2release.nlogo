...
to-report calculate-movement-probability
  ...
  let dist-from-release ln 100 * (distancexy [release-site-x] of focal-deer [release-site-y] of focal-deer)  ; Compute the distance from the mature deers release point/centre of HR - logged in this version
...
setup</setup>
  ...
  <experiment name="100 sims" repetitions="100" runMetricsEveryStep="false">
    <setup>clear-all
random-seed behaviorspace-run-number
setup</setup>
    <go>go</go>
