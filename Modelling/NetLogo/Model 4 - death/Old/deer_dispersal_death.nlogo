...
to go
  ...
  ;if time:get "day" dt = 16 and time:get "month" dt = 12 and time:get "year" dt = 2020 and time:get "hour" dt = 10 [export-visit-map-and-home-ranges]
  ;if time:get "day" dt = 16 and time:get "month" dt = 12 and time:get "year" dt = 2025 and time:get "hour" dt = 10 [export-visit-map-and-home-ranges]
  ;if time:get "day" dt = 16 and time:get "month" dt = 12 and time:get "year" dt = 2030 and time:get "hour" dt = 10 [export-visit-map-and-home-ranges]
  ;if time:get "day" dt = 16 and time:get "month" dt = 12 and time:get "year" dt = 2035 and time:get "hour" dt = 10 [export-visit-map-and-home-ranges]
  ;if time:get "day" dt = 16 and time:get "month" dt = 12 and time:get "year" dt = 2040 and time:get "hour" dt = 10 [export-visit-map-and-home-ranges]
  ;if time:get "day" dt = 16 and time:get "month" dt = 12 and time:get "year" dt = 2045 and time:get "hour" dt = 10 [export-visit-map-and-home-ranges]
  ;if time:get "day" dt = 16 and time:get "month" dt = 12 and time:get "year" dt = 2050 and time:get "hour" dt = 10 [export-visit-map-and-home-ranges]
...
to death
  ...
  foreach sort deer [t -> ask t [
    let rand-number random-float 1
    if mature = "yes" and rand-number > (annual-survival-prob) ^ (1 / 730.5) [ die ] ; For adult deer, if random number is greater than survival rate for a 12 hour period - deer dies
...
to export-visit-map-and-home-ranges

  let rand random 1e7
  ask one-of patches [
    set test_file gis:patch-dataset n-visits ; Collects the n-visit variables from the patches
  ]
  gis:store-dataset test_file (word "output_maps/n-visits_" rand) ; Exports the n-visit raster as an .asc raster

  ask deer [ set home-range-patches remove-duplicates home-range-patches ] ; Double checks that duplicate patches are removed
  csv:to-file (word "Results/home-range-sizes_" rand ".csv") [ (list who (length home-range-patches)) ] of deer
...
499
65
Export visit map and home ranges
export-visit-map-and-home-ranges
NIL
1
T
