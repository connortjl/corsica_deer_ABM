...
to go
  ...
  if time:get "day" dt = 16 and time:get "month" dt = 12 and time:get "year" dt = 2040 and time:get "hour" dt = 10 [export-visit-map export-home-range-sizes set hpc-stop "yes"]
