  ...
  ask deer with [sex-of-deer = "female" and mature = "yes"] [ ; For female mature deer
    ...
    if rand-number > (1 - annual-birth-prob) ^ (1 / 730.5) and offspring = "no" [
      ...
      hatch 1 [ ; Birth to 1 offspring
        ...
        ; set prior-patch patch-here ; This was used for calculating step lengths, doesn't look to be used now
...
to-report calculate-movement-probability
  ...
  let dist-from-release ln (distancexy [release-site-x] of focal-deer [release-site-y] of focal-deer)  ; Compute log of the distance from the mature deers release point/centre of HR
